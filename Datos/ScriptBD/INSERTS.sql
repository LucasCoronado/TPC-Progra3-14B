...
-- 3. TABLA: Productos
-- Nota: IdMarca e IdCategoria toman valores del 1 al 10 generados arriba
...
-- 10. TABLA: DetalleVentas
-- Nota: Los PreciosUnitarios reflejan el PrecioCompra + Ganancia (aprox)
