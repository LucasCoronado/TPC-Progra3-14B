<%@ Page Title="Historial de Ventas" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="HistorialVentas.aspx.cs" Inherits="TPComercio.HistorialVentas" %>
    ...
    <div class="max-w-7xl mx-auto py-8">
        ...
        <div class="bg-white p-6 rounded-2xl shadow-sm border border-slate-200 mb-8 flex gap-4 items-end flex-wrap">
            <div class="flex-1 min-w-[200px]">
                <label class="block text-sm font-semibold text-slate-700 mb-1">Buscar por Cliente</label>
                <asp:TextBox ID="txtFiltroCliente" runat="server" CssClass="w-full px-4 py-2 border border-slate-300 rounded-lg focus:ring-2 focus:ring-blue-500 outline-none" placeholder="Ej: Juan Perez"></asp:TextBox>
            </div>
            <div class="w-40">
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden">
            <asp:GridView ID="dgvVentas" runat="server" CssClass="w-full text-left border-collapse" AutoGenerateColumns="false" GridLines="None" EmptyDataText="No hay ventas registradas.">
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Vendedor">
                        <ItemStyle CssClass="px-6 py-4 text-slate-600 text-center" />
                        <ItemTemplate>
                            <%# Eval("RegistradoPor.NombreUsuario") %>
                        </ItemTemplate>
                    </asp:TemplateField>
                    ...
                    <asp:TemplateField HeaderText="Acciones">
                        ...
                        <ItemTemplate>
                            ...
                            <a href='VentaDetalle.aspx?id=<%# Eval("Id") %>' class="bg-blue-50 text-blue-600 hover:bg-blue-100 font-semibold py-2 px-4 rounded-lg transition-colors text-sm">
                                Ver Detalles
                            </a>
                        </ItemTemplate>
                    </asp:TemplateField>
