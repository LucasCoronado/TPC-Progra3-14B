...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="max-w-5xl mx-auto py-8">
        ...
        <div class="flex items-center justify-between mb-8">
            <div>
                <h1 class="text-3xl font-bold text-slate-800">Detalle de Compra
                    <asp:Label ID="lblNroCompra" runat="server" CssClass="text-blue-600"></asp:Label>
                </h1>
                <p class="text-slate-500 mt-2">Desglose de productos de la operación seleccionada.</p>
            </div>
            <a href="HistorialCompras.aspx" class="bg-slate-200 hover:bg-slate-300 text-slate-700 font-bold py-2 px-6 rounded-lg transition-colors inline-block">Volver al Historial
            </a>
        </div>
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-slate-200 p-6 mb-8 flex flex-wrap gap-8">
            ...
            <div>
                ...
                <asp:Label ID="lblProveedor" runat="server" CssClass="text-lg font-medium text-slate-900"></asp:Label>
            </div>
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden">
            <asp:GridView ID="dgvDetalles" runat="server" CssClass="w-full text-left border-collapse" AutoGenerateColumns="false" GridLines="None" EmptyDataText="No se encontraron detalles para esta compra.">
